"""{indicator_id} - TODO: one sentence on what this measures and why it matters.

Owner:  {owner}
Source: TODO name + URL
Run:    python run.py build {category} {indicator_id}

Output: {category}/indicators/{indicator_id}.csv in the shared format (docs/DATA_FORMAT.md)
"""
...
def build() -> pd.DataFrame:
    ...
    #    {category}/raw/ so we never download the same thing twice.
